...
> = {
  createCategory: Resolver<
    GQLResolversTypes["Category"],
    ParentType,
    ContextType,
    RequireFields<GQLMutationcreateCategoryArgs, "data">
  >;
  createProduct: Resolver<
    GQLResolversTypes["Product"],
    ParentType,
    ContextType,
    RequireFields<GQLMutationcreateProductArgs, "data">
  >;
  createUser: Resolver<
    GQLResolversTypes["User"],
    ParentType,
    ContextType,
    RequireFields<GQLMutationcreateUserArgs, "data">
  >;
  deleteCategory: Resolver<
    GQLResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<GQLMutationdeleteCategoryArgs, "id">
  >;
  deleteProduct: Resolver<
    GQLResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<GQLMutationdeleteProductArgs, "id">
  >;
  deleteUser: Resolver<
    GQLResolversTypes["Boolean"],
    ParentType,
  ...
  updateCategory: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<GQLMutationupdateCategoryArgs, "data">
  >;
  updateProduct: Resolver<
    GQLResolversTypes["Product"],
    ParentType,
    ContextType,
    RequireFields<GQLMutationupdateProductArgs, "data">
  >;
  updateUser: Resolver<
    GQLResolversTypes["User"],
    ParentType,
    ContextType,
    RequireFields<GQLMutationupdateUserArgs, "data">
  >;
};
...
> = {
  categoryAll: Resolver<
    ReadonlyArray<GQLResolversTypes["Category"]>,
    ParentType,
    ContextType
  >;
  categoryByField: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<GQLQuerycategoryByFieldArgs, "fields">
  >;
  categoryById: Resolver<
    Maybe<GQLResolversTypes["Category"]>,
    ParentType,
    ContextType,
    RequireFields<GQLQuerycategoryByIdArgs, "id">
  >;
  productAll: Resolver<
    ReadonlyArray<GQLResolversTypes["Product"]>,
    ParentType,
    ContextType
  >;
  productByField: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<GQLQueryproductByFieldArgs, "fields">
  >;
  productById: Resolver<
    Maybe<GQLResolversTypes["Product"]>,
    ParentType,
    ContextType,
    RequireFields<GQLQueryproductByIdArgs, "id">
  >;
  userAll: Resolver<
  ...
  userByField: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<GQLQueryuserByFieldArgs, "fields">
  >;
  userById: Resolver<
    Maybe<GQLResolversTypes["User"]>,
    ParentType,
    ContextType,
    RequireFields<GQLQueryuserByIdArgs, "id">
  >;
};
...
> = {
  ...
  products: Resolver<
    Maybe<ReadonlyArray<Maybe<GQLResolversTypes["Product"]>>>,
    ParentType,
    ContextType
  >;
  createdAt: Resolver<
...
export type GQLProductResolvers<
  ContextType = GraphQLContext,
  ParentType extends GQLResolversParentTypes["Product"] = GQLResolversParentTypes["Product"]
> = {
  id: Resolver<GQLResolversTypes["ID"], ParentType, ContextType>;
  name: Resolver<GQLResolversTypes["String"], ParentType, ContextType>;
  ...
  category: Resolver<
    Maybe<ReadonlyArray<Maybe<GQLResolversTypes["Category"]>>>,
    ParentType,
    ContextType
  >;
  createdAt: Resolver<
...
export type GQLLogResolvers<
  ContextType = GraphQLContext,
  ParentType extends GQLResolversParentTypes["Log"] = GQLResolversParentTypes["Log"]
> = {
  id: Resolver<GQLResolversTypes["ID"], ParentType, ContextType>;
...
export type GQLGenericErrorResolvers<
  ContextType = GraphQLContext,
  ParentType extends GQLResolversParentTypes["GenericError"] = GQLResolversParentTypes["GenericError"]
> = {
  __resolveType: TypeResolveFn<"SimpleError", ParentType, ContextType>;
  message: Resolver<GQLResolversTypes["String"], ParentType, ContextType>;
};

export type GQLSimpleErrorResolvers<
  ContextType = GraphQLContext,
  ParentType extends GQLResolversParentTypes["SimpleError"] = GQLResolversParentTypes["SimpleError"]
> = {
  message: Resolver<GQLResolversTypes["String"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
