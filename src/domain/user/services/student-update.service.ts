...
interface StudantUpdateBody {
    id: string; type: "STUDENT_UPDATE";
    data: {
        userId: string;
...
export const processStudentUpdateEvent =
    (db: DatabaseService, log: FastifyLoggerInstance) => async (event: StudantUpdateBody): Promise<WebhookResponse> => {
